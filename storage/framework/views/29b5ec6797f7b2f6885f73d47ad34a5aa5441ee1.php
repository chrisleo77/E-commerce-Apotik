...
<body>
    ...
    <div class="side-navbar active-nav d-flex justify-content-between flex-wrap flex-column">
        <ul class="nav flex-column text-white w-100 p-3">
            ...
            <li class="nav-item">
                <a class="nav-link text-dark" href="#">Data Pembeli</a>
            </li>
            <li class="nav-item">
...
</html><?php /**PATH D:\Data Kuliah\Semester 6\Web Framework Programming\UAS\UASWFP_GENAP2122_ApotekU\resources\views/layouts/admin.blade.php ENDPATH**/ ?>