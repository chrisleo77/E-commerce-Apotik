<form method="POST" action="<?php echo e(route('obat.update', $dataMedicine->id)); ?>">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" id="eDesc" name="description" rows="3"><?php echo e($dataMedicine->description); ?></textarea>
        </div>
        <div class="form-group">
...
<?php /**PATH D:\Data Kuliah\Semester 6\Web Framework Programming\UAS\New folder\New folder\UASWFP_GENAP2122_ApotekU\resources\views/admin/obat/getEditForm.blade.php ENDPATH**/ ?>