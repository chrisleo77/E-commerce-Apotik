                ...
                <tbody>
                    <?php $__currentLoopData = $listMedicines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $li): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr id="tr_<?php echo e($li->id); ?>">
                            ...
                            <td id="td-generic_name-<?php echo e($li->id); ?>"><?php echo e($li->generic_name); ?></td>
                            <td id="td-form-<?php echo e($li->id); ?>"><?php echo e($li->form); ?></td>
                            <td id="td-restriction_formula-<?php echo e($li->id); ?>"><?php echo e($li->restriction_formula); ?></td>
                            <td id="td-price-<?php echo e($li->id); ?>"><?php echo e($li->price); ?></td>
                            <td id="td-description-<?php echo e($li->id); ?>"><?php echo e($li->description); ?></td>
                            <td><img src="<?php echo e(asset('images/' . $li->image)); ?>" alt="" height='200'></td>
                            <td id="td-faskes_tk1-<?php echo e($li->id); ?>"><?php echo e($li->faskes_tk1); ?></td>
                            <td id="td-faskes_tk2-<?php echo e($li->id); ?>"><?php echo e($li->faskes_tk2); ?></td>
                            <td id="td-faskes_tk3-<?php echo e($li->id); ?>"><?php echo e($li->faskes_tk3); ?></td>
                            <td id="td_category_<?php echo e($li->id); ?>"><?php echo e($li->category_id); ?></td>

                            
                            <td>
                                <a href="#modalEdit" data-target="#modalEdit" data-toggle='modal' class="btn btn-success"
                                    onclick="getEditForm(<?php echo e($li->id); ?>)"><i class="fa fa-edit"></i> Ubah</a>
                                
                                <a class="btn btn-danger"
                                onclick="if(confirm('Are you sure to delete this record?')) deleteDataRemoveTR(<?php echo e($li->id); ?>)"><i class="fa fa-trash"></i> Delete</a>
                            </td>
                        </tr>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="basic" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form enctype="multipart/form-data" method="POST" action="<?php echo e(route('obat.store')); ?>">
...
<?php $__env->startSection('scripts'); ?>
    <script>
        function getEditForm(id) {
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('obat.getEditForm')); ?>",
                data: {
        ...
        function saveDataUpdateTD(id) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('obat.saveData')); ?>",
                data: {
                    '_token': '<?php echo csrf_token(); ?>',
                    'id': id,
        ...
        function deleteDataRemoveTR(id) {
            $.ajax({
                type: 'POST',
                url: "<?php echo e(route('obat.deleteData')); ?>",
                data: {
                    '_token': '<?php echo csrf_token(); ?>',
                    'id': id
                },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Data Kuliah\Semester 6\Web Framework Programming\UAS\New folder\New folder\UASWFP_GENAP2122_ApotekU\resources\views/admin/obat/index.blade.php ENDPATH**/ ?>